...
def rollout(process_index: int, rollout_config: RolloutConfig, config: CNNConfigBase) -> None:
...
def main(rollout_config: RolloutConfig, config: CNNConfigBase) -> None:
...
if __name__ == '__main__':
    ...
    # load config
    config = CNNConfigBase.load_from_yaml(yaml_path=args.config,
                                          allow_illegal_keys=True) if args.config else CNNConfigBase()
